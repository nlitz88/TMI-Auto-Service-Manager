...
Public Class mfgMaintenance
    ...
    Private Sub mfgMaintenance_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing

        ' Check if editing/adding, and if editing/adding, check if control values changed
        If AutoMake_Textbox.Visible And InitialAutoManufacturersValues.CtrlValuesChanged() Then
