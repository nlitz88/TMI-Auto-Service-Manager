Public Class unpaidInvoicesReport
    ...
    Private Sub unpaidInvoicesReport_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If Not CRUD.HasException(True) Then
                If CRUD.DbDataTable.Rows.Count <> 0 Then
                    ...
                    AcccessInstance.DoCmd.OpenReport(ReportName:="UnpaidInvoices", Microsoft.Office.Interop.Access.AcView.acViewPreview, , WhereCondition:="InvDate>=#" + CStr(StartDateTextbox.Text) + "#")
