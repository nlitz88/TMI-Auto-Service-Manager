...
Public Class paymentMaintenance
    ...
    Private Sub paymentMaintenance_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing

        ' Check if editing/adding, and if editing/adding, check if control values changed
        If PaymentType_Textbox.Visible And InitialPTValues.CtrlValuesChanged() Then
